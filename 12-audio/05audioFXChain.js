...
function preload(){
	track = loadSound('12-audio/assets/TomWaitsEmotionalWeatherReport.mp3');
}
...
function updateSliders(){
	...
	console.log("delay: " + delaySlider.value());
	
	compressor.set(compressorSlider.value());
	console.log("compressor: " + compressorSlider.value());

	filter.set(filterSlider.value());
	console.log("filter: " + filterSlider.value());
